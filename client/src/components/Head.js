            ...
            <div className="mobile__menu"></div>
                <nav className="menu">
                    <ul className="menu__list">
                        <li><a href="../pages/aboutme.html" className="menu__link">обо мне</a></li>
                        <li><a href="../index.html" className="menu__link">ньювости</a></li>
                        <li><a href="../pages/projects.html" className="menu__link">мои проекты</a></li>
                        <li><a href="../pages/weirdstuff.html" className="menu__link">черновик</a></li>
                        <li><a href="../pages/contacts.html" className="menu__link">контакты</a></li>
                    </ul>
                </nav>
